...
namespace ECommerceSql
{
	...
	public class Account
	{
		...
		/// <summary>
		/// Accesses the stored procedure in the database AccountList to list all the records from Account
		/// </summary>
		/// <returns>A DataTable object, or possibly null. The DataTable returned is a collection of all the rows from Account</returns>
		// V2Generator: Section Start : List
		public static DataTable AccountList ()
		{
			// V2Generator: Body Start
			return SqlData.getSelectDataTable(SqlData.MASTER,"AccountList");
		...
		public static DataTable AccountGetByID (int ID)
		{
			// V2Generator: Body Start
			SqlParameter[] param			=
				{
			...
			return SqlData.getSelectDataTable(SqlData.MASTER,"AccountGetByID", param);
			// V2Generator: Body End
		}
