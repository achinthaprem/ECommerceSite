...
namespace ECommerce.Tables.Active.HR
{
	...
	public class Account : GenericPrincipal, IComparable, IUser
	{
		...
		public void Update(string firstName, string lastName, string email, string contactNo, string shippingAddress, string country, int role)
		{
			this.Update(firstName, lastName, email, this.m_Password, this.m_Salt, contactNo, shippingAddress, country, this.m_Status, role, this.m_DateCreated, DateTime.Now, this.m_CreatedAccountID, this.m_ModifiedAccountID);
		}

		public void UpdatePassword(string password, string salt)
		{
			this.Update(this.m_FirstName, this.m_LastName, this.m_Email, password, salt, this.ContactNo, this.m_ShippingAddress, this.m_Country, this.m_Status, this.m_Role, this.m_DateCreated, DateTime.Now, this.m_CreatedAccountID, this.m_ModifiedAccountID);
		}

		public void UpdateStatus(int status)
		{
			this.Update(this.m_FirstName, this.m_LastName, this.m_Email, this.m_Password, this.m_Salt, this.ContactNo, this.m_ShippingAddress, this.m_Country, status, this.m_Role, this.m_DateCreated, DateTime.Now, this.m_CreatedAccountID, this.m_ModifiedAccountID);
		}

		public void Update()
		{
			this.Update(this.m_FirstName, this.m_LastName, this.m_Email, this.m_Password, this.m_Salt, this.ContactNo, this.m_ShippingAddress, this.m_Country, this.m_Status, this.m_Role, this.m_DateCreated, DateTime.Now, this.m_CreatedAccountID, this.m_ModifiedAccountID);
		}
		...
		public string UserName
		{
			get
			{
				//string              result          = this.m_Identifier;
		...
		{
			get { return string.Format("{0} {1}", this.m_FirstName, this.m_LastName); }
		}
		...
		public string FullName
		{
			get
			{
				...
				if (!String.IsNullOrEmpty(this.m_FirstName) && !String.IsNullOrEmpty(this.m_LastName))
				{
					result                      = string.Format("{0} {1}", this.m_FirstName, this.m_LastName);
				}
		...
		public string DisplayUserID
		{
			get
			{
				string          result          =  this.m_Email;

				//if (!String.IsNullOrEmpty(this.m_Identifier))
				//{
				//	result                      = this.m_Identifier;
				//}
