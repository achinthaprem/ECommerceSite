...
namespace ECommerce.Tables.Content
{
	...
	public class Order : Object, IComparable
	{
		...
		/// <summary>
		/// Order is placed and payed.
		/// </summary>
		public const int        STATUS_COMPLETED        = 1;

		/// <summary>
		/// Order is placed, but not payed.
		/// </summary>
		public const int        STATUS_PENDING			= 0;

		#endregion

		#region Payment Method Constants

		/// <summary>
		/// Payed by Credit Card.
		/// </summary>
		public const int        PAYMENT_METHOD_CREDIT_CARD				= 1;
		...
		/// Payed by Bitcoin.
		/// </summary>
		public const int        PAYMENT_METHOD_BITCOIN                  = 2;
