...
namespace ECommerceTables
{
	...
	public class ShippingInfo : Object, IComparable
	{
		...
		public static ShippingInfo ExecuteCreate (int ID)
		{
			...
			DataTable   				  dt  		  = ECommerceSql.ShippingInfo.ShippingInfoGetByID(ID);
		...
		public static List<ShippingInfo> List ()
		{
			...
			DataTable			dt					= ECommerceSql.ShippingInfo.ShippingInfoList();
		...
		{
			// V2Generator: Body Start
			ECommerceSql.ShippingInfo.ShippingInfoDelete (this.m_ID);
			// V2Generator: Body End
		}
		...
		{
			// V2Generator: Body Start
			ECommerceSql.ShippingInfo.ShippingInfoUpdate (ID, OrderID, Type, Cost, Address);
		...
		{
			// V2Generator: Body Start
			this.m_ID			= ECommerceSql.ShippingInfo.ShippingInfoInsert (this.m_OrderID, this.m_Type, this.m_Cost, this.m_Address);
			// V2Generator: Body End
		}
